...
nadjanolte@Nadjas-MacBook-Air bin % vim barcode_
nadjanolte@Nadjas-MacBook-Air bin % ls            
BarRank.R		barcode_plot.png
barcode_		barcode_thresholds.txt
nadjanolte@Nadjas-MacBook-Air bin % vim BarRank.R 
