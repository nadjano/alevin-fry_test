...
process alevin_MR2 {
    ...
    output:
        ...
        file '.command.log' into  into MEM_ALEVIN_MR2
...
process alevin_MR1 {
    ...
    output:
        ...
        file '.command.log' into  into MEM_ALEVIN_MR1
...
process run_STARSolo {
    ...
    file '.command.log' into  into MEM_STAR
...
process kb_count_MR1 {
    ...
    output:
        ...
        file '.command.log' into MEM_KB_MR1
...
process kb_count_MR2 {
    ...
    output:
        ...
        file '.command.log' into  into MEM_KB_MR2
...
// run alevin-fry for quantification with splici index
 process alevin_fry_MR3 {
    ...
    output:
        ...
        file '.command.log' into MEM_ALEVIN_FRY_MR3
...
// cat preRNA_referenceGtf.gtf | awk  '{print \$10"\\t"\$12}' | awk  '{print \$2"\\t"\$1}' > t2g_transcriptome.txt
 ...
 process alevin_fry_MR2 {
    ...
    output:
        ...
        file '.command.log' into MEM_ALEVIN_FRY_MR2
...
process alevin_fry_MR1 {
    ...
    output:
        ...
        file '.command.log' into  into MEM_ALEVIN_FRY_MR1
