...
process index_alevin_transcript_for_fry {
    ...
    cat preRNA_referenceGtf.gtf | grep -vE "^#" | awk '{split(\$0, array, "transcript_id"); print array[2]}' | awk '{split(\$0, array, ";"); print array[1]}' | sed 's/"//g' | sed 's/^ *//g' | sed 's/transcript://g' > t.txt

    cat preRNA_referenceGtf.gtf | grep -vE "^#" | awk '{split(\$0, array, "gene_id"); print array[2]}' | awk '{split(\$0, array, ";"); print array[1]}' | sed 's/"//g' | sed 's/^ *//g'| sed 's/gene://g'  > g.txt
